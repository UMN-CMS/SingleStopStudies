...
\begin{frame}{Kernels and Scales Continued}
  ...
  \item The most common kernel is the RBF kernel
    ...
    \end{equation}
  \item Let us see how this kernel lets us extrapolate $m_{\stopq}$ in to the blinded window indicated by the red bars, for different length scales $\ell$.
  \end{itemize}
  ...
  \end{center}
  \begin{onlyenv}<3>
    \posannot[30:3cm]{ls1}{fill=UMNMaroon!10, draw=UMNMaroon}{Small length scales have no extrapolating power.}
    \posannot[210:3cm]{ls2}{fill=UMNMaroon!10, draw=UMNMaroon}{Long lengths scales can't fit well.}
  \end{onlyenv}
\end{frame}
...
\begin{frame}{Fit Using GRBF}
  \begin{center}
    \markimage{\includegraphics[width=0.3\textwidth]{figures/2dpullplots/grbf/E_1200_0p5_100_0p05.pdf}}{0.3,0.5}{rbf2}
    ...
    \markimage{\includegraphics[width=0.3\textwidth]{figures/2dpullplots/grbf/E_1500_0p5_150_0p07.pdf}}{0.3,0.3}{rbf1}
  ...
  \end{center}
  \begin{onlyenv}<2>
    \posannot[20:3]{rbf1}{fill=UMNMaroon!10, draw=UMNMaroon}{Allowing off-diagonal terms improved pulls.}
    \posannot[-20:3]{rbf2}{fill=UMNMaroon!10, draw=UMNMaroon}{Ridge behavior is reduced.}
  \end{onlyenv}
\end{frame}
