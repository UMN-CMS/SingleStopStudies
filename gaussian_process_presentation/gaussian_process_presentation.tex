  ...
  \begin{center}
    \scalebox{0.8}{
      \begin{tabular}{|ccccc|}
        ...
        \multicolumn{5}{|c|}{\texttt{HLT\_PFHT1050 | HLT\_AK8PFJet400\_TrimMass30}} \\
        ...
        \multicolumn{5}{|c|}{$\Delta R_{\mathrm{b_1,b_2}} > 1$ } \\ 
        ...
        $\mathrm{N_b } \geq 2$ & $\mathrm{N_b } \geq 2$ & $\mathrm{N_b } \geq 3$ & $\mathrm{N_b} \geq 3$ & $\mathrm{N_{b}} = 0$ \\
